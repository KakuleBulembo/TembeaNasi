...
import 'package:tembea/screens/admin/admin_screens/gyms/view_gym.dart';

import 'form/gym_main_form.dart';

class DashboardGyms extends StatefulWidget {
  const DashboardGyms({
    Key? key
  }) : super(key: key);
  static String id = 'dashboard_gyms';

  @override
  _DashboardGymsState createState() => _DashboardGymsState();
}

class _DashboardGymsState extends State<DashboardGyms> {
    ...
    return Column(
      children:  [
        AddButton(
          ...
          addLabel: 'Add Gym',
          onPressed: (){
            Navigator.pushNamed(context, GymMainForm.id);
          },),
        const SizedBox(
          height: 16.0,
        ),
                            ...
                            Responsive.isWeb(context) ? ButtonBlue(
                              ...
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return ViewGym(activity: data.docs[index],);
                                }));
                              },
