...
import 'gym_secondary_form.dart';

class GymMainForm extends StatefulWidget {
  const GymMainForm({
    Key? key,
  }) : super(key: key);
  static String id = 'gym_main_form';

  @override
  _GymMainFormState createState() => _GymMainFormState();
}

class _GymMainFormState extends State<GymMainForm> {
  late String name;
