...
class GymSecondaryForm extends StatefulWidget {
  const GymSecondaryForm({
    Key? key,
    required this.name,
  ...
  @override
  _GymSecondaryFormState createState() => _GymSecondaryFormState();
}

class _GymSecondaryFormState extends State<GymSecondaryForm> {
