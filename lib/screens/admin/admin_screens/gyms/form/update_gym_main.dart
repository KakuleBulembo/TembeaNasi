...
import 'package:tembea/screens/admin/admin_screens/gyms/form/update_gym_secondary.dart';

import '../../../../../constants.dart';

class UpdateGymMain extends StatefulWidget {
  const UpdateGymMain({
    Key? key,
  ...
  @override
  _UpdateGymMainState createState() => _UpdateGymMainState();
}

class _UpdateGymMainState extends State<UpdateGymMain> {
  String ? name;
  String ? location;
  String ? description;
  String ? price;
                              ...
                              child: RoundedViewDetailsButton(
                                ...
                                onPressed: () {
                                  Navigator
                                    ...
                                    return UpdateGymSecondary(activity: widget.activity);
                                  }));
                                },
                              ),
                            ),
