...
import 'hotel_secondary_form.dart';

class HotelMainForm extends StatefulWidget {
  const HotelMainForm({
    Key? key
  }) : super(key: key);
  static String id = 'hotel_main_form';

  @override
  _HotelMainFormState createState() => _HotelMainFormState();
}

class _HotelMainFormState extends State<HotelMainForm> {
  late String name;
