...
class HotelSecondaryForm extends StatefulWidget {
  const HotelSecondaryForm({
    Key? key,
    required this.name,
  ...
  @override
  _HotelSecondaryFormState createState() => _HotelSecondaryFormState();
}

class _HotelSecondaryFormState extends State<HotelSecondaryForm> {
