...
class UpdateHotelSecondary extends StatefulWidget {
  const UpdateHotelSecondary({
    Key? key,
  ...
  @override
  _UpdateHotelSecondaryState createState() => _UpdateHotelSecondaryState();
}

class _UpdateHotelSecondaryState extends State<UpdateHotelSecondary> {
