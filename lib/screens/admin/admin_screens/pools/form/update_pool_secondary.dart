...
class UpdatePoolSecondary extends StatefulWidget {
  const UpdatePoolSecondary({
    Key? key,
  ...
  @override
  _UpdatePoolSecondaryState createState() => _UpdatePoolSecondaryState();
}

class _UpdatePoolSecondaryState extends State<UpdatePoolSecondary> {
                          ...
                          if(imageList.isNotEmpty) {
                            FirebaseStorage.instance.refFromURL(activity['PhotoUrl']).delete().then((value) {
                              ...
                              FirebaseFirestore.instance.collection('activities').doc(widget.activity.reference.id).update({
                                ...
                                showToast(message: 'Pool Updated',
                                  color: Colors.green,
                                );
