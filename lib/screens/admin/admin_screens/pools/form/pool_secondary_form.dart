...
class PoolSecondaryForm extends StatefulWidget {
  const PoolSecondaryForm({
    Key? key,
    required this.name,
  ...
  @override
  _PoolSecondaryFormState createState() => _PoolSecondaryFormState();
}

class _PoolSecondaryFormState extends State<PoolSecondaryForm> {
