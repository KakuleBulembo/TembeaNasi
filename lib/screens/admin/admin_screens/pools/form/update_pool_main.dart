...
import 'package:tembea/screens/admin/admin_screens/pools/form/update_pool_secondary.dart';

import '../../../../../constants.dart';


class UpdatePoolMain extends StatefulWidget {
  const UpdatePoolMain({
    Key? key,
  ...
  @override
  _UpdatePoolMainState createState() => _UpdatePoolMainState();
}

class _UpdatePoolMainState extends State<UpdatePoolMain> {
  String ? name;
  String ? location;
  String ? description;
  String ? price;
                                ...
                                child: RoundedViewDetailsButton(
                                  ...
                                  onPressed: () {
                                    Navigator
                                      ...
                                      return UpdatePoolSecondary(activity: widget.activity);
                                    }));
                                  },
                                ),
                              ),
