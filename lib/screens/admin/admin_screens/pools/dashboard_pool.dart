...
import 'package:tembea/screens/admin/admin_screens/pools/view_pool.dart';

import 'form/pool_main_form.dart';

class DashboardPool extends StatefulWidget {
  const DashboardPool({
    Key? key,
  }) : super(key: key);
  static String id = 'dashboard_pool';

  @override
  _DashboardPoolState createState() => _DashboardPoolState();
}

class _DashboardPoolState extends State<DashboardPool> {
  final Stream<QuerySnapshot> activities = FirebaseFirestore
      .instance.collection('activities')
      .where('Type', isEqualTo: 'Pool')
    ...
    return Column(
      children:  [
        AddButton(
          ...
          addLabel: 'Add Pool',
          onPressed: (){
            Navigator.pushNamed(context, PoolMainForm.id);
          },),
        const SizedBox(
          height: 16.0,
        ),
                            ...
                            Responsive.isWeb(context) ? ButtonBlue(
                              ...
                              onPressed: (){
                                Navigator.push(context, MaterialPageRoute(builder: (context){
                                  return ViewPool(activity: data.docs[index],);
                                }));
                              },
                                ...
                                showDialog(
                                    ...
                                    builder: (BuildContext context){
                                      return ShowDialog(
                                        ...
                                        dialogTitle: "Delete",
                                        dialogContent: "Do you really want to delete ${data.docs[index]['Name']} pool?",
                                      );
                                    });
                              },
