...
class CinemaSecondaryForm extends StatefulWidget {
  const CinemaSecondaryForm({
    Key? key,
    required this.name,
  ...
  @override
  _CinemaSecondaryFormState createState() => _CinemaSecondaryFormState();
}

class _CinemaSecondaryFormState extends State<CinemaSecondaryForm> {
