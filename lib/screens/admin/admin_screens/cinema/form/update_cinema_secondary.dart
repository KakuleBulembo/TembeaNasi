...
class UpdateCinemaSecondary extends StatefulWidget {
  const UpdateCinemaSecondary({
    Key? key,
  ...
  @override
  _UpdateCinemaSecondaryState createState() => _UpdateCinemaSecondaryState();
}

class _UpdateCinemaSecondaryState extends State<UpdateCinemaSecondary> {
                          ...
                          if(imageList.isNotEmpty) {
                            FirebaseStorage.instance.refFromURL(activity['PhotoUrl']).delete().then((value) {
                              ...
                              FirebaseFirestore.instance.collection('activities').doc(widget.activity.reference.id).update({
                                ...
                                showToast(message: 'Cinema Updated',
                                  color: Colors.green,
                                );
