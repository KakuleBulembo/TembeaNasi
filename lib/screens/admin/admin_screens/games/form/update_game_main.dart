...
import 'package:tembea/screens/admin/admin_screens/games/form/update_game_secondary.dart';

import '../../../../../constants.dart';

class UpdateGameMain extends StatefulWidget {
  const UpdateGameMain({
    Key? key,
  ...
  @override
  _UpdateGameMainState createState() => _UpdateGameMainState();
}

class _UpdateGameMainState extends State<UpdateGameMain> {
  String ? name;
  String ? location;
  String ? description;
  String ? price;
                              ...
                              child: RoundedViewDetailsButton(
                                ...
                                onPressed: () {
                                  Navigator
                                    ...
                                    return UpdateGameSecondary(activity: widget.activity);
                                  }));
                                },
                              ),
                            ),
